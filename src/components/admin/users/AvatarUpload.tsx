  ...
  return (
    <>
      <div className={`relative ${className}`}>
        <div className="relative w-20 h-20 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 p-0.5 shadow-lg">
          ...
          <Button
            variant="secondary"
            size="sm"
            className="absolute -bottom-1 -right-1 rounded-full w-8 h-8 p-0 bg-white dark:bg-gray-800 border-2 border-blue-500 hover:bg-gray-50 dark:hover:bg-gray-700 shadow-lg"
